...
@property (assign, nonatomic) MTMathAtomType type;
/** The nucleus of the atom. */
@property (nonatomic, copy) NSString *nucleus;
/** An optional superscript. */
@property (retain, nonatomic) MTMathList *superScript;
/** An optional subscript. */
@property (retain, nonatomic) MTMathList *subScript;
...
@property (retain, nonatomic) MTMathList *numerator;
/// Denominator of the fraction
@property (retain, nonatomic) MTMathList *denominator;
...
@property (retain, nonatomic) NSString *leftDelimiter;
/** An optional delimiter for a fraction on the right. */
@property (retain, nonatomic) NSString *rightDelimiter;
...
@property (retain, nonatomic) MTMathList *radicand;
...
@property (retain, nonatomic) MTMathList *degree;
...
/// The inner math list
@property (retain, nonatomic) MTMathList *innerList;
/// The left boundary atom. This must be a node of type kMTMathAtomBoundary
@property (retain, nonatomic) MTMathAtom *leftBoundary;
/// The right boundary atom. This must be a node of type kMTMathAtomBoundary
@property (retain, nonatomic) MTMathAtom *rightBoundary;
...
@property (nonatomic, readonly) NSMutableArray *alignments;
...
@property (assign, nonatomic) CGFloat interColumnSpacing;
...
@property (assign, nonatomic) CGFloat interRowAdditionalSpacing;
