 ...
 */
@property (assign, nonatomic) MTMathList *mathList;
...
/** The latex string to be displayed. Setting this will remove any `mathList` that
 ...
 @see error */
@property (assign, nonatomic) NSString *latex;
...
@property (assign, nonatomic) BOOL displayErrorInline;

/** The MTFont to use for rendering. */
@property (retain, nonatomic) MTFont *font;
...
@property (assign, nonatomic) MTMathUILabelMode labelMode;

/** Horizontal alignment for the text. The default is align left. */
@property (assign, nonatomic) MTTextAlignment textAlignment;
